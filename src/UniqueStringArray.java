...
// FIND THE FIRST PRODUCT IN THE ARRAY THAT OCCURS UNIQUELY. If no unique products, return null.
...
public class UniqueStringArray {
    ...
    public static void main(String[] args) {
        System.out.println(UniqueStringArray.firstUniqueProduct(new String[]{"Apple", "Computer", "Apple", "Bag"}));
    }
}
